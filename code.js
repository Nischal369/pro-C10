...
box5.shapeColor="darkred";
var box6 = createSprite(275, 75, 50, 50);
box6.shapeColor="indigo";
...
box12.shapeColor="darkgreen";
var box13 = createSprite(225, 125, 50, 50);
box13.shapeColor="purple";
var box14 = createSprite(275, 125, 50, 50);
box14.shapeColor="darkorange";
...
function draw() {
  ...
  if (gamestate == "serve") {
    textSize(17);
    text("Welcome,Please press enter key to start", 30, 200);
    if(keyDown("enter")){
      ball.velocityX = 3;
      ball.velocityY = 4;
      gamestate = "play"
  ...
  if (gamestate == "end") {
      ...
      ball.velocityY = 0;
      textSize(12);
      text("YOUR SCORE IS : "+score,140,200);
